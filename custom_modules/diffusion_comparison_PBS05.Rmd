...
```{r}
#without Cells
exact_0p0001<- read.csv("../HM05-noCells_0p0001/voxel_values_1.csv")
#dt_0p01<-seq(0,0.9,0.1)
solution_0p001<- read.csv("../HM05-noCells_0p001/voxel_values_1.csv")
solution_0p01<- read.csv("../HM05-noCells_0p01/voxel_values_1.csv")
solution_0p02<- read.csv("../HM05-noCells_0p02/voxel_values_1.csv")
solution_0p05<- read.csv("../HM05-noCells_0p05/voxel_values_1.csv")
solution_0p1<- read.csv("../HM05-noCells_0p1/voxel_values_1.csv")
solution_0p2<- read.csv("../HM05-noCells_0p2/voxel_values_1.csv")
solution_0p5<- read.csv("../HM05-noCells_0p5/voxel_values_1.csv")
...
```{r}
#with cells
exact_0p0001 <- read.csv("../HM05-withCells_0p0001/voxel_values_1.csv")
solution_0p001<- read.csv("../HM05-withCells_0p001/voxel_values_1.csv")
solution_0p01<- read.csv("../HM05-withCells_0p01/voxel_values_1.csv")
solution_0p02<- read.csv("../HM05-withCells_0p02/voxel_values_1.csv")
solution_0p05<- read.csv("../HM05-withCells_0p05/voxel_values_1.csv")
solution_0p1<- read.csv("../HM05-withCells_0p1/voxel_values_1.csv")
solution_0p2<- read.csv("../HM05-withCells_0p2/voxel_values_1.csv")
solution_0p5<- read.csv("../HM05-withCells_0p5/voxel_values_1.csv")
dt_0p01<-seq(0.0,10,1)
...
```{r}
exact_0p0001 <- exact_0p0001 %>% select(current_time,concentration_salt,voxel_id) %>% arrange(voxel_id,current_time)
solution_0p001<- solution_0p001 %>% select(current_time,concentration_salt,voxel_id) %>% arrange(voxel_id,current_time)
solution_0p01<- solution_0p01 %>% select(current_time,concentration_salt,voxel_id) %>% arrange(voxel_id,current_time)
solution_0p02<- solution_0p02 %>% select(current_time,concentration_salt,voxel_id) %>% arrange(voxel_id,current_time)
solution_0p05<- solution_0p05 %>% select(current_time,concentration_salt,voxel_id) %>% arrange(voxel_id,current_time)
solution_0p1<- solution_0p1 %>% select(current_time,concentration_salt,voxel_id) %>% arrange(voxel_id,current_time)
solution_0p2<- solution_0p2 %>% select(current_time,concentration_salt,voxel_id) %>% arrange(voxel_id,current_time)
solution_0p5<- solution_0p5 %>% select(current_time,concentration_salt,voxel_id) %>% arrange(voxel_id,current_time)
#acc_voxels_0p01_total <- acc_voxels_current
#unique(acc_voxels_0p01_1$current_time)
test_difference <- abs(exact_0p0001$concentration_salt - solution_0p001$concentration_salt)
max(test_difference)
```
...
log_log_plot_0
ggsave("PBS05_diffusion_noCells.png")
```