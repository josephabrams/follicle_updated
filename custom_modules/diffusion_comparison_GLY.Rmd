...
```{r}
#without Cells
exact_0p0001<- read.csv("../GLY-noCells_0p0001/voxel_values_1.csv")
#dt_0p01<-seq(0,0.9,0.1)
solution_0p001<- read.csv("../GLY-noCells_0p001/voxel_values_1.csv")
solution_0p01<- read.csv("../GLY-noCells_0p01/voxel_values_1.csv")
solution_0p02<- read.csv("../GLY-noCells_0p02/voxel_values_1.csv")
solution_0p05<- read.csv("../GLY-noCells_0p05/voxel_values_1.csv")
solution_0p1<- read.csv("../GLY-noCells_0p1/voxel_values_1.csv")
solution_0p2<- read.csv("../GLY-noCells_0p2/voxel_values_1.csv")
solution_0p5<- read.csv("../GLY-noCells_0p5/voxel_values_1.csv")
...
```{r}
#with cells
exact_0p0001 <- read.csv("../GLY-withCells_0p0001/voxel_values_1.csv")
solution_0p001<- read.csv("../GLY-withCells_0p001/voxel_values_1.csv")
solution_0p01<- read.csv("../GLY-withCells_0p01/voxel_values_1.csv")
solution_0p02<- read.csv("../GLY-withCells_0p02/voxel_values_1.csv")
solution_0p05<- read.csv("../GLY-withCells_0p05/voxel_values_1.csv")
solution_0p1<- read.csv("../GLY-withCells_0p1/voxel_values_1.csv")
solution_0p2<- read.csv("../GLY-withCells_0p2/voxel_values_1.csv")
solution_0p5<- read.csv("../GLY-withCells_0p5/voxel_values_1.csv")
dt_0p01<-seq(0.0,10,1)
...
log_log_plot_0
ggsave("GLY_diffusion_withCells.png")
```