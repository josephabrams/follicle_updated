...
std::vector <int> general_voxel_bounding_box(std::vector starting_position, std::vector ending_position, double voxel_ BioFVM::Cartesian_Mesh underlying_mesh* a_mesh);
