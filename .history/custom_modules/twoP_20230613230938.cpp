...
void dN_molarity(std::vector<double> *Ps, double *surface_area, std::vector<double> *exterior_molarity, std::vectordouble *internal_molarity, std::vector<double> *dN)
{
    //multisolute
...
// 
void two_p(double* Lp, double* R, double* T, double* surface_area, double* exterior_osmolality, double* internal_osmolality, std::vector<double>* dVw, double *exterior_molarity, double *Ps, double *internal_molarity, std::vector<double> *dN, std::vector<double> *previous_dN, double dt, double *water_volume, double *previous_water_volume, std::vector <double> *moles, std::vector <double> *previous_moles )
{
