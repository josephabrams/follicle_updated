...
// 
void two_p(double* Lp, double* R, double* T, double* surface_area, double* exterior_osmolality, double* internal_osmolality, std::vector<double>* dVw, double *exterior_molarity, double *Ps, double *internal_molarity, std::vector<double> *dN, double dt, double *water_volume, double std::vector <double> *moles )
{
