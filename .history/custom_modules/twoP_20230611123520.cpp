...
void two_parameter_water_osmolality(const double *Lp, const double *R, const double *T, double *surface_area, double *exterior_osmolality, double *internal_osmolality, std::vector)
{
