...
void two_p(double const *Lp, double const *R, double const *T, double *surface_area, double *exterior_osmolality, double *internal_osmolality, std::vector<double> *dVw, double *exterior_molarity, double *internal_molarity, std::vector<double> *dN, double dt, std::d *water_volume )
{
