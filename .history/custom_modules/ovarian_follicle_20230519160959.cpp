...
*/
	...
	microenvironment.diffusion_coefficients[1] = 53;
	microenvironment.decay_rates[1] = 0;


	microenvironment.add_density( "GLY", "dimensionless" );
	microenvironment.diffusion_coefficients[2] = 53;//530; //TODO: check about the diffusivity of this value
	...
	default_microenvironment_options.initial_condition_vector[1]=7.77;
