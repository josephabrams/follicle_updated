...
void get_molarities(pCellmstd::vector<double> *exterior_molarity, std::vector<double> *internal_molarity, std::vector<double> *internal_moles, double *water_volume)
{
