...
Spring_Cell::Spring_Cell(Cell* pCell)//(Cell* pCell,Phenotype& phenotype)
{
  ...
  m_my_pCell=pCell;
    ...
    // temperature=293.15;
    // gas_constant=0.08205;
    // surface_area=pCell->custom_;
    // next_water_volume;//for ABM 2nd order
    // water_volume;
    // dVw;//cell water flux
    // previous_dVw;
    // solute_moles;
    // dN;//cell mole flux of solutes

    // exterior_osmolality;//total exterior osmolality salt+CPA (mole/kg)
    // interior_osmolality;// total internal osmolality salt+CPA
    // internal_molarity;
    // external_molarity;
