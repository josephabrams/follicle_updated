...
std::vector <int> general_voxel_bounding_box(std::vector <double> starting_position, std::vector ending_position, double voxel_length, BioFVM::Cartesian_Mesh* a_mesh);
