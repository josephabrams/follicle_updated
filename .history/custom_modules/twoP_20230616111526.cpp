...
void get_molarities(pCell*std::vector<double> *exterior_molarity, std::vector<double> *internal_molarity, std::vector<double> *internal_moles, double *water_volume)
{
