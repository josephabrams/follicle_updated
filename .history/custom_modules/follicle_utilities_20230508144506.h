...
void attach_neighbooring_springs(Cell* pCell, double max_spring_length);
void initialize_neighbooring_spring_connections();
...
void non_connected_neighboor_pressure(Cell* pCell, double dt);
