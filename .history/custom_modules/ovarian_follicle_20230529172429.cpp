...
{
	std::vector <double> basement_membrane_center={0.0,0.0}
	basement_membrane_mechanics(spring_cell_by_pCell_index[pCell->index], 100, std::vector <double> basement_membrane_center)
