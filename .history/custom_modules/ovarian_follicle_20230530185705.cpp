...
{
	pCell->phenotype.volume.total=1000;
	 #pragma omp critical
	 {
...
void setup_4_granulosa_test_case(void)
{
	 ...
	 spring_cell_by_pCell_index.resize(9);
	...
	pCell_granulosa1a->set_total_volume(666);
	...
	pCell_granulosa1b->set_total_volume(666);
	create_spring_cell_from_cell(pCell_granulosa1b, pCell_granulosa1b->phenotype); 
	...
	pCell_granulosa2a->set_total_volume(666);
	create_spring_cell_from_cell(pCell_granulosa2a, pCell_granulosa2a->phenotype); 
	...
	pCell_granulosa2b->set_total_volume(666);
	//create_spring_cell_from_cell(pCell_granulosa2b, pCell_granulosa2b->phenotype); 
	...
	pCell_granulosa3a->set_total_volume(666);
	create_spring_cell_from_cell(pCell_granulosa3a, pCell_granulosa3a->phenotype); 
	...
	std::cout<<"VOLUME TEST"<<pCell_granulosa3b->custom_data["initial_volume"]<<"\n";
	...
	create_spring_cell_from_cell(pCell_granulosa4a, pCell_granulosa4a->phenotype); 
	...
	create_spring_cell_from_cell(pCell_granulosa4b, pCell_granulosa4b->phenotype); 
	create_spring_cell_from_cell(pCell_oocyte, oocyte_cell.phenotype); 
	std::cout<<"TEST"<<pCell_oocyte->phenotype.volume.total<<"\n";
	create_spring_cell_from_cell(pCell_granulosa1a, pCell_granulosa1a->phenotype); 
	std::cout<<"TEST"<<pCell_granulosa1a->phenotype.volume.total<<"\n";
