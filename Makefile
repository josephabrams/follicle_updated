...
ovarian_follicle.o: ./custom_modules/ovarian_follicle.cpp
	$(COMPILE_COMMAND) -c ./custom_modules/ovarian_follicle.cpp

follicle_utilities.o: ./custom_modules/follicle_utilities.cpp
	$(COMPILE_COMMAND) -c ./custom_modules/follicle_utilities.cpp
